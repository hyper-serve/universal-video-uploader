---
title: Adapters
description: Adapters connect the library to your video backend. Pick one and wire it into UploadProvider.
---
...
See the [Custom Adapter](/guides/custom-adapter/) guide.
