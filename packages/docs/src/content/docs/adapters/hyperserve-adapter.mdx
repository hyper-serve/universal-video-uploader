...
The first-party adapter for the [Hyperserve](https://hyperserve.io/?utm_source=docs&utm_medium=body&utm_campaign=video-uploader&utm_content=adapter-hyperserve) video API.

:::note
Using Hyperserve requires an API key. Hyperserve offers free accounts and pay-per-usage plans — [sign up at hyperserve.io](https://hyperserve.io/?utm_source=docs&utm_medium=body&utm_campaign=video-uploader&utm_content=adapter-hyperserve-signup).
:::
