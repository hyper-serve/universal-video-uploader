...
```tsx
import { ViewModeProvider } from "@hyperserve/video-uploader-react";
...
```tsx
import { useViewMode } from "@hyperserve/video-uploader-react";
...
```tsx
import { ViewModeProvider } from "@hyperserve/video-uploader-react-native";
